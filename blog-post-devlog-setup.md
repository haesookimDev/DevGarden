# DevLog: AI 기반 기술 블로그 플랫폼 구축기

## Overview

개인 기술 블로그와 포트폴리오를 통합 관리하면서, AI를 활용해 문서/코드 분석 기반 블로그 자동 생성까지 지원하는 풀스택 플랫폼 "DevLog"을 구축했다. 핵심 차별점은 PDF/DOCX/PPTX 업로드 또는 GitHub/GitLab URL 입력만으로 기술 블로그 초안을 자동으로 생성하는 에이전틱 AI 기능이다.
